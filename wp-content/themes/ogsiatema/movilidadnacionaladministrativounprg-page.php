<?php
/*
Template Name: Página Movilidad UNPRG Nivel Nacional Administrativo 
*/
?>
<?php get_header(); ?> 
            ...
            <div class=" flex seccion-2">
                <div class="row">
                    <div class="col s12 l7 offset-l2">
                        <h2 class="white-text titulo-portada">Programa de Movilidad Administrativo</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col s12 hide" id="instituciones_elegibles" style="margin:15px 0px!important;">
                    ...
                    <ul class="collection ">
                        <?php while( have_rows('ies_elegibles') ): the_row();
                            ...
                            ?>
                        <a href="<?php echo $content_enlace; ?>" class="collection-item black-text" target="_blank">
                            <?php echo $content_universidad; ?>
                        </a>
                        <?php endwhile; ?>
                    </ul>
                    <?php endif; ?>

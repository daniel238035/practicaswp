                  ...
                  <div class="card" style="padding:0px!important;">
                    ...
                    <div class="card-content" style="padding:15px!important;">
                      <div class="row flex-row">
                        <div class="col s10">
                          <h5 class="titulo-borde-izquierdo-2 activator">Nombre de la Convocatoria</h5>
                        </div>
                        <div class="col s2">
                    ...
                    <div class="card-action" style="padding: 5px 5px!important">
                      <a class="btn btn-flat green-text text-negrita" href="http://localhost/practicas/movilidad.php" >Inscríbete</a>
                    </div>
